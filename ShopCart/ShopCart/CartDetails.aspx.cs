    ...
    public partial class CartDetails : System.Web.UI.Page
    {
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            ...
            for (int k = 1; k <= c; k++)
            {
                ...
                string str3 = "insert into Order_TB values(" + registid + ", '" + productid + "'," + productquantity + "," + subtotal + ",'Active','" + dt + "')";
            ...
            string st1 = "select sum(Sub_Total) from Order_TB";
            string sub = ob.FunScalar(st1);

            int subt = Convert.ToInt32(sub);
            string str5 = "select * from Order_TB";
